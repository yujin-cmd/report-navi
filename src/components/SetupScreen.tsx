...
import { OBJECTIVE_TYPES, type ReportSession } from '../types';
import { Icon, PageShell } from './common';

export function SetupScreen({ session, onContinue }: { session: ReportSession; onContinue: (session: ReportSession) => void }) {
